...
This page contains links to license agreements of the third party 组件 used within {{site.data.var.ece}}.  Click the **License** links to view the end user license agreement for the corresponding software.
...
tubalmartin/cssmin |4.1.0| BSD-3-Clause|[Source](https://github.com/tubalmartin/YUI-CSS-compressor-PHP-port)| 否 license
