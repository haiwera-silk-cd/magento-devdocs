...
This page contains links to license agreements of the third party 组件 used within Magento Open Source.  Click the **License** links to view the end user license agreement for the corresponding software.
