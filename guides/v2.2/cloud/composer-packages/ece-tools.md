...
-  <!-- MAGECLOUD-1221 -->Deployment validation fails if an `ADMIN_EMAIL`或`ADMIN_USERNAME` value is the same as an existing Magento administrator account.
...
-  Added the following new [**环境变量**](http://devdocs.magento.com/guides/v2.2/cloud/env/variables-intro.html):
    ...
    -   `WARM_UP_PAGES`—You can list the pages to use to pre-load the cache. Available in the new [部署后变量](http://devdocs.magento.com/guides/v2.2/cloud/env/variables-post-deploy.html).
