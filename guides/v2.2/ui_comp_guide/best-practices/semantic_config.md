...
![node declaration autocomplete]({{ site.magentourl }}/common/images/ui_comps/autocomplete1.png){:width="610px"}

* Attribute declaration autocomplete:

![Attribute declaration autocomplete]({{ site.magentourl }}/common/images/ui_comps/autocomplete1.png){:width="630px"}
...
![no defined interface]({{ site.magentourl }}/common/images/ui_comps/no_type.png){:width="410px"}
