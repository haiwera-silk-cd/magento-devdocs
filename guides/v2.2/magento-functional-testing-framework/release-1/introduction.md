...
The Magento Functional Testing Framework (MFTF) aims to replace the [功能测试框架] in future releases to make test creation easier for developers and improve qualities like:
