...
1. When you update Magento, verify that the Magento [WYSIWYG settings](getting-started.html#wysiwyg-settings) and [安全设置](getting-started.html#security-settings) are set appropriately.
