...
![Choose what to install, update, or uninstall]({{ site.magentourl }}/common/images/extens_mgr_updates.png){:width="500px"}
...
![Extension Manager columns]({{ site.magentourl }}/common/images/extensman_columns-only.png)
...
![Review and install extensions]({{ site.magentourl }}/common/images/extensman_review-purchases.png){:width="450px"}

The Ready to Install page displays as follows.

![Display a list of extensions you can install]({{ site.magentourl }}/common/images/extensman_ready-to-install-pg.png){:width="450px"}

The following sections discuss your options.

### Get more information
To get more information about an extension, click ![Get information about an extension]({{ site.magentourl }}/common/images/extensman_icon_question.png).

### Install one extension
To install one extension, click the **Install** link at the end of its row and continue with [步骤1.准备就绪检查]({{ page.baseurl }}/comp-mgr/extens-man/extensman-readiness.html).
...
1.	Select the check box next to each extension, or click **Select All** from the list as the following figure shows.
	...
	![Choose extensions to install]({{ site.magentourl }}/common/images/extensman_choose-to-install.png){:width="550px"}
2.	After you select what to install, click **Install** at the top of the page as the following figure shows.

	![Install your purchases]({{ site.magentourl }}/common/images/extensman_ready-to-install.png){:width="550px"}
3.	Continue with [步骤1.准备就绪检查]({{ page.baseurl }}/comp-mgr/extens-man/extensman-readiness.html).
...
1.	In the Installed Extensions section, click **Uninstall** from the **Actions** list as the following figure shows.
	...
	![Uninstall extensions]({{ site.magentourl }}/common/images/extensman_uninstall.png){:width="600px"}
...
![List of extensions that can be updated]({{ site.magentourl }}/common/images/extensman_new-updates.png){:width="600px"}
...
*	To update more than one extension, select its check box and click **Update**, as the following figure shows.
	...
	![Update selected extensions]({{ site.magentourl }}/common/images/extensman_update-selected.png){:width="500px"}
*	To update all extensions, click **Select All** from the list and click **Update**, as the following figure shows.

	![Update all extensions]({{ site.magentourl }}/common/images/extensman_update-all.png)

Continue with [步骤1.准备就绪检查]({{ page.baseurl }}/comp-mgr/extens-man/extensman-readiness.html).
