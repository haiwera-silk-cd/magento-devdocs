...
Each {% glossarytooltip c1e4242b-1f1a-44c3-9d72-1d5b1435e142 %}模块{% endglossarytooltip %} can have a global and area-specific `di.xml` file.
...
| `VALUE_TYPE`     | Specifies the type of value: either `sensitive`或`environment`.                                                                                              |
