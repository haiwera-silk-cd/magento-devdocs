...
## Functional
  ...
  For more information, see the [功能测试框架手册]({{ page.baseurl }}/mtf/mtf_introduction.html){:target="_blank"}.
...
## API Functional 
  ...
  For more information, see the [Web API功能测试]({{ page.baseurl }}/get-started/web-api-functional-testing.html){:target="_blank"}.
...
## Integration  
  ...
  For more information, see [运行集成测试]({{ page.baseurl }}/test/integration/integration_test_execution.html){:target="_blank"}.
...
## Unit  
  ...
  For more information, see [运行单元测试]({{ page.baseurl }}/test/unit/unit_test_execution.html){:target="_blank"}.
