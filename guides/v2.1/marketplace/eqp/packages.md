...
You can delete a package only if you specify a `submission_id`或`item_id` as a query parameter. Deleting a package is risky operation, and as a result, you cannot delete them in a batch.
