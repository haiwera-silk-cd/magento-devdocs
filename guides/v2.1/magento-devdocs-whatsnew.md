...
Added configuration info for [creating nginx virtual hosts](https://devdocs.magento.com/guides/v2.0/config-guide/multi-site/ms_nginx.html#ms-nginx-vhosts) on 教程-在nginx下设置多站或多店 page.|2.x|Technical changes|May 10
...
New [小向导](http://devdocs.magento.com/guides/v2.2/cloud/env/smart-wizards.html) help you to verify your Cloud configuration follows best practices.|2.1.x, 2.2.x, 2.3.x|New|Apr 24
...
Added the [最佳高效实践](http://devdocs.magento.com/guides/v2.2/performance-best-practices/index.html) guide. It replaces the information formerly in the topic Magento Optimization Guide.|2.2.x, 2.3.x|New topic|Apr 10
...
Added the `SKIP_HTML_MINIFICATION` environment variable to the Cloud [环境变量 reference](http://devdocs.magento.com/guides/v2.2/cloud/env/variables-intro.html) that skips copying the static view files in the `var/view_preprocessed` directory.|2.1.x, 2.2.x|Updated|Apr 02
...
Added support for PHP 7.1 in the [Magento企业版(云支持版) Guide](http://devdocs.magento.com/guides/v2.2/cloud/requirements/cloud-requirements.html).|2.2.x|Updated|Mar 12
...
Updated the [Magento企业版(云支持版) Guide 路由配置](http://devdocs.magento.com/guides/v2.2/cloud/project/project-conf-files_routes.html) topic to deprecate the `:php` endpoint and to note that now you can use the dot (\.) symbol to separate the subdomain instead of using the triple dash (\-\-\-).|2.2.x|Updated|Mar 09
...
Release notes for Magento企业版(云支持版) [`ece-tools v2002.0.8`](http://devdocs.magento.com/guides/v2.2/cloud/composer-packages/ece-tools.html#v200208).|2.2.x|Updated|Jan 31
We added instructions for [managing message queues](http://devdocs.magento.com/guides/v2.2/cloud/env/working-with-variables.html#manage-message-queues) on Magento企业版(云支持版) using the `CRON_CONSUMERS_RUNNER` environment variable.|2.2.x|Updated|Jan 31
...
Added a new section in the Magento企业版(云支持版) guide for release notes related to the [`ece-patches`](http://devdocs.magento.com/guides/v2.2/cloud/composer-packages/ece-patches.html) Composer package.|2.2.x|New, Updated|Dec 20
Published release notes for the Magento企业版(云支持版) [`ece-tools 2002.0.7`](http://devdocs.magento.com/guides/v2.2/cloud/composer-packages/ece-tools.html#v200207) Composer package.|2.2.x|Updated|Dec 20
Added a new topic about setting up the [Bitbucket集成](http://devdocs.magento.com/guides/v2.2/cloud/project/bitbucket-integration.html) for Magento企业版(云支持版).|2.x|New|Dec 18
...
Updated the following Magento企业版(云支持版) topics to include details about static content compression during build/deploy phases:<br/>- [Configuration Management](http://devdocs.magento.com/guides/v2.2/cloud/live/sens-data-over.html#cloud-confman-scd-over)<br/>- [部署过程](http://devdocs.magento.com/guides/v2.2/cloud/reference/discover-deploy.html)|2.2.x|Updated|Dec 06
Magento企业版(云支持版) will now auto-generate an `app/etc/config.php` file if it doesn't detect one in your project directory during the build phase. Updated references to configuration management in the [部署过程](http://devdocs.magento.com/guides/v2.2/cloud/reference/discover-deploy.html) topic.|2.2.x|Updated|Dec 06
Replaced references to the `mysqldump` command with the new [`vendor/bin/ece-tools db-dump`](http://devdocs.magento.com/guides/v2.2/cloud/project/project-webint-snap.html#db-dump) CLI command for Staging and Production environments in the Magento企业版(云支持版) guide|2.2.x|Updated|Dec 06
...
Added a [new troubleshooting section](http://devdocs.magento.com/guides/v2.2/cloud/configure/setup-cron-jobs.html#reset-cron-jobs) to the Magento企业版(云支持版) cron topic describing how to reset Magento cron jobs|2.2.x|Updated|Nov 30
Revised and added new content for Magento企业版(云支持版) for custom Fastly VCLs including [快速定制VCL片段](http://devdocs.magento.com/guides/v2.2/cloud/configure/cloud-vcl-custom-snippets.html), [定制VCL白名单](http://devdocs.magento.com/guides/v2.2/cloud/configure/fastly-vcl-whitelist.html), [定制VCL黑名单](http://devdocs.magento.com/guides/v2.2/cloud/configure/fastly-vcl-blacklist.html), [VCL自定义延长管理员超时](http://devdocs.magento.com/guides/v2.2/cloud/configure/fastly-vcl-extend-timeout.html), [Custom redirect to Wordpress VCL](http://devdocs.magento.com/guides/v2.2/cloud/configure/fastly-vcl-wordpress.html), and [VCL自定义块坏引用](http://devdocs.magento.com/guides/v2.2/loud/configure/fastly-vcl-badreferer.html).|2.0.x, 2.1.x, 2.2.x, 2.x|New|Nov 29
Update content for Magento企业版(云支持版) for [Composer](http://devdocs.magento.com/guides/v2.2/cloud/reference/cloud-composer.html) commands and files, add new content for [Git](http://devdocs.magento.com/guides/v2.2/cloud/reference/git-integration.html), added Security Scan Tool info to [上线和发布](http://devdocs.magento.com/guides/v2.2/cloud/live/live.html), add .gitignore info to [项目结构](http://devdocs.magento.com/guides/v2.2/cloud/project/project-start.html), add notes to [Magento企业版(云支持版)补丁](http://devdocs.magento.com/guides/v2.2/cloud/project/project-patch.html), update information for upgrading Fastly in [Magento企业版(云支持版)升级](http://devdocs.magento.com/guides/v2.2/cloud/project/project-upgrade.html), and updated redirects|2.0.x, 2.1.x, 2.2.x, 2.x|Updated|Nov 29
...
Updated Magento企业版(云支持版) content for MS SQL Server drivers in [Configure your environments](http://devdocs.magento.com/guides/v2.2/cloud/env/environments.html#sqldriver)|2.0.x, 2.1.x, 2.2.x, 2.x|Updated|Nov 27
Updated and added content for Magento企业版(云支持版) including [主题问题排查](http://devdocs.magento.com/guides/v2.2/cloud/trouble/theme-troubleshooting.html), POP locations for [快速设置](http://devdocs.magento.com/guides/v2.2/cloud/access-acct/fastly.html), notes to [设置定时任务](http://devdocs.magento.com/guides/v2.2/cloud/configure/setup-cron-jobs.html), security for [使用项目的web接口管理分支](http://devdocs.magento.com/guides/v2.2/cloud/project/project-webint-branch.html), worker information for [.magento.app.yaml](http://devdocs.magento.com/guides/v2.2/cloud/project/project-conf-files_magento-app.html), and branch information in [Pro architecture](http://devdocs.magento.com/guides/v2.2/cloud/reference/discover-arch.html)|2.0.x, 2.1.x, 2.2.x, 2.x|Updated|Nov 27
Update troubleshooting content for [实体属性值(EAV)和扩展属性](http://devdocs.magento.com/guides/v2.2/extension-dev-guide/attributes.html)|2.0.x, 2.1.x, 2.2.x, 2.x|Updated|Nov 27
Updated Magento企业版(云支持版) for [导入现存的代码到项目](http://devdocs.magento.com/guides/v2.2/cloud/access-acct/first-time-setup_import-first-steps.html), [Prepare your existing Magento Commerce code](http://devdocs.magento.com/guides/v2.2/cloud/access-acct/first-time-setup_import-prepare.html), [Import code and data to Magento企业版(云支持版)](http://devdocs.magento.com/guides/v2.2/cloud/access-acct/first-time-setup_import-import.html)|2.0.x, 2.1.x, 2.2.x, 2.x|Updated|Nov 22
...
Updated the recommended Fastly module version 1.2.33 for Magento企业版(云支持版): [Fastly](http://devdocs.magento.com/guides/v2.2/cloud/basic-information/cloud-fastly.html), [技术和要求](http://devdocs.magento.com/guides/v2.2/cloud/requirements/cloud-requirements.html), and [Magento企业版(云支持版) third party licenses](http://devdocs.magento.com/guides/v2.2/release-notes/thirdparty-mccloud.html)|2.0.x, 2.1.x, 2.2.x, 2.x|Updated|Nov 15
Updated content for Magento企业版(云支持版) including Configuration Management for [2.1.X](http://devdocs.magento.com/guides/v2.1/cloud/live/sens-data-over.html) and [2.2.X](http://devdocs.magento.com/guides/v2.2/cloud/live/sens-data-over.html), Deployment Process [2.0.X](http://devdocs.magento.com/guides/v2.0/cloud/reference/discover-deploy.html), [2.1.X](http://devdocs.magento.com/guides/v2.1/cloud/reference/discover-deploy.html), and [2.2.X](http://devdocs.magento.com/guides/v2.2/cloud/reference/discover-deploy.html)|2.0.x, 2.1.x, 2.2.x, 2.x|Updated|Nov 14
Updated [快速设置](http://devdocs.magento.com/guides/v2.2/cloud/access-acct/fastly.html) and [快速故障排查](http://devdocs.magento.com/guides/v2.2/cloud/trouble/trouble_fastly.html) for Magento企业版(云支持版) for handling existing Fastly accounts|2.0.x, 2.1.x, 2.2.x, 2.x|Updated|Nov 14
Updated how to [配置Xdebug](http://devdocs.magento.com/guides/v2.2/cloud/howtos/debug.html) for Magento企业版(云支持版).|2.0.x, 2.1.x, 2.2.x, 2.x|Updated|Nov 13
Updated [订阅和计划](http://devdocs.magento.com/guides/v2.2/cloud/basic-information/cloud-plans.html) with information on options you can purchase including AWS Managed VPN Connection Service access|2.0.x, 2.1.x, 2.2.x, 2.x|Updated|Nov 13
...
Updated [设置Magento B2B](http://devdocs.magento.com/guides/v2.2/cloud/configure/setup-b2b.html) with additional documentation links and error message updates for Magento企业版(云支持版)|2.2.x|Updated|Nov 09
Updated Magento企业版(云支持版) information for [Blackfire.io](http://devdocs.magento.com/guides/v2.2/cloud/project/project-integrate-blackfire.html) module enablement and environment naming and [New Relic APM](http://devdocs.magento.com/guides/v2.2/cloud/project/new-relic.html) for their university information|2.0.x, 2.1.x, 2.2.x, 2.x|Updated|Nov 09
...
Updated [Magento application environment variables](http://devdocs.magento.com/guides/v2.2/cloud/env/environment-vars_magento.html) and [部署过程](http://devdocs.magento.com/guides/v2.2/cloud/reference/discover-deploy.html) with scopes and SCD_STRATEGY variable for Magento企业版(云支持版) 2.2.1|2.2.x|Updated|Nov 07
Updated [New Relic APM](http://devdocs.magento.com/guides/v2.2/cloud/project/new-relic.html) license and environment information for Magento企业版(云支持版)|2.0.x, 2.1.x, 2.2.x, 2.x|Updated|Nov 06
Update relationship name for [RabbitMQ](http://devdocs.magento.com/guides/v2.2/cloud/project/project-conf-files_services-rabbit.html) service for Magento企业版(云支持版)|2.0.x, 2.1.x, 2.2.x, 2.x|Updated|Nov 06
Update Magento企业版(云支持版) content for deploy commands in [部署代码并迁移静态文件和数据](http://devdocs.magento.com/guides/v2.2/cloud/live/stage-prod-migrate.html)for new and existing Pro plans and [Magento application environment variables](http://devdocs.magento.com/guides/v2.2/cloud/env/environment-vars_magento.html)|2.0.x, 2.1.x, 2.2.x, 2.x|Updated|Nov 06
Updated 快速故障排查 and supported features for Magento企业版(云支持版) in [Fastly](http://devdocs.magento.com/guides/v2.2/cloud/basic-information/cloud-fastly.html) and [快速故障排查](http://devdocs.magento.com/guides/v2.2/cloud/trouble/trouble_fastly.html)|2.0.x, 2.1.x, 2.2.x, 2.x|Updated|Nov 03
{% endcollapsibleh2 %}
...
Updated Magento企业版(云支持版) content for Fastly including [Fastly](http://devdocs.magento.com/guides/v2.2/cloud/basic-information/cloud-fastly.html), [快速设置](http://devdocs.magento.com/guides/v2.2/cloud/access-acct/fastly.html), [快速定制VCL片段](http://devdocs.magento.com/guides/v2.2/cloud/configure/cloud-vcl-custom-snippets.html), and [Troubleshoot Fastly](http://devdocs.magento.com/guides/v2.2/cloud/trouble/trouble_fastly.html)|2.0.x, 2.1.x, 2.2.x, 2.x|Updated|Oct 30
Add [B2B module set up](http://devdocs.magento.com/guides/v2.2/cloud/configure/setup-b2b.html) information for Magento企业版(云支持版)|2.2.x|New|Oct 27
Update SSH tunneling info to Magento企业版(云支持版) in [SSH和sFTP](http://devdocs.magento.com/guides/v2.2/cloud/env/environments-ssh.html) and [使用命令行管理分支](http://devdocs.magento.com/guides/v2.2/cloud/env/environments-start.html).|2.0.x, 2.1.x, 2.2.x, 2.x|Updated|Oct 25
Update database troubleshooting for Magento企业版(云支持版) in Migrate and deploy static files and data for [2.1](http://devdocs.magento.com/guides/v2.1/cloud/live/stage-prod-migrate.html) and [2.2](http://devdocs.magento.com/guides/v2.2/cloud/live/stage-prod-migrate.html)|2.1.x, 2.2.x|Updated|Oct 24
Add new content for trial Onboarding Portal for Magento企业版(云支持版) including [Subscription and plans](http://devdocs.magento.com/guides/v2.2/cloud/basic-information/cloud-plans.html), [新手上路任务](http://devdocs.magento.com/guides/v2.2/cloud/onboarding/onboarding-tasks.html), [Onboarding Portal management](http://devdocs.magento.com/guides/v2.2/cloud/onboarding/onboarding-portal.html), [Prepare project environments](http://devdocs.magento.com/guides/v2.2/cloud/before/before-project-owner.html), and [欢迎使用Magento企业版(云支持版)](http://devdocs.magento.com/guides/v2.2/cloud/bk-cloud.html)|2.0.x, 2.1.x, 2.2.x, 2.x|New|Oct 23
Updated content for Magento企业版(云支持版) for the updated Pro projects in [管理你的项目](http://devdocs.magento.com/guides/v2.2/cloud/project/projects.html), [Add Staging and Production to Pro projects](http://devdocs.magento.com/guides/v2.2/cloud/trouble/pro-env-management.html), [部署你的网店](http://devdocs.magento.com/guides/v2.2/cloud/live/stage-prod-live.html), [部署过程](http://devdocs.magento.com/guides/v2.2/cloud/reference/discover-deploy.html), [准备部署准生产和生产环境](http://devdocs.magento.com/guides/v2.2/cloud/live/stage-prod-migrate-prereq.html), and [测试部署](http://devdocs.magento.com/guides/v2.2/cloud/live/stage-prod-test.html)|2.0.x, 2.1.x, 2.2.x, 2.x|Updated|Oct 20
...
Update Magento企业版(云支持版) content for new features for Pro plan: [管理你的项目](http://devdocs.magento.com/guides/v2.2/cloud/project/projects.html), [Add Staging and Production to Pro projects](http://devdocs.magento.com/guides/v2.2/cloud/trouble/pro-env-management.html), [配置你的项目](http://devdocs.magento.com/guides/v2.2/cloud/project/project-webint-basic.html), [创建和管理用户](http://devdocs.magento.com/guides/v2.2/cloud/project/user-admin.html), [Manage branches with the Interface](http://devdocs.magento.com/guides/v2.2/cloud/project/project-webint-branch.html), [Magento Cloud CLI reference](http://devdocs.magento.com/guides/v2.2/cloud/reference/cli-ref-topic.html), [欢迎使用Magento企业版(云支持版)](http://devdocs.magento.com/guides/v2.2/cloud/bk-cloud.html), [架构起步](http://devdocs.magento.com/guides/v2.2/cloud/basic-information/starter-architecture.html), and [Pro architecture](http://devdocs.magento.com/guides/v2.2/cloud/reference/discover-arch.html)|2.0.x, 2.1.x, 2.2.x, 2.x|Updated|Oct 18
Update Magento企业版(云支持版) content for [开发和部署工作流起步](http://devdocs.magento.com/guides/v2.2/cloud/basic-information/starter-develop-deploy-workflow.html), [Pro develop and deploy workflow](http://devdocs.magento.com/guides/v2.2/cloud/welcome/discover-workflow.html), [安装Magento](http://devdocs.magento.com/guides/v2.2/cloud/before/before-setup-env-install.html), [配置管理](http://devdocs.magento.com/guides/v2.2/cloud/live/sens-data-over.html) and [管理系统特定配置的示例](http://devdocs.magento.com/guides/v2.2/cloud/live/sens-data-initial.html), [Magento企业版(云支持版)升级](http://devdocs.magento.com/guides/v2.2/cloud/project/project-upgrade.html), and [欢迎使用Magento企业版(云支持版)](http://devdocs.magento.com/guides/v2.2/cloud/bk-cloud.html)|2.0.x, 2.1.x, 2.2.x, 2.x|Updated|Oct 17
Add [cron](http://devdocs.magento.com/guides/v2.2/cloud/configure/setup-cron-jobs.html) and [sFTP](http://devdocs.magento.com/guides/v2.2/cloud/env/environments-ssh.html#sftp) content for Magento企业版(云支持版)|2.0.x, 2.1.x, 2.2.x, 2.x|New|Oct 12
...
Description  | Versions applied to  | New or Updated | Date
-------------|--------------|----------------------|--------
[Update Admin account password change on project provision and creation for Magento企业版(云支持版)](http://devdocs.magento.com/guides/v2.0/cloud/onboarding/onboarding-tasks.html)|2.0.x, 2.1.x, 2.2.x, 2.x|Updated|Sep 27
...
Updated content for [Configuration Management](http://devdocs.magento.com/guides/v2.2/cloud/live/sens-data-over.html) and [corresponding examples](http://devdocs.magento.com/guides/v2.2/cloud/live/sens-data-initial.html) for in Magento企业版(云支持版).|2.2.x|Updated|Sep 08
...
| Description  | Versions applied to  | New or Updated | Date |
|--------------|--------------|----------------------|--------|
| [配置手册](http://devdocs.magento.com/guides/v2.2/config-guide/bk-config-guide.html){:target="_blank"} | 2.2 |  Updated | June 23  |
...
| [Magento的部署配置](http://devdocs.magento.com/guides/v2.2/config-guide/config/config-php.html){:target="_blank"} | 2.2 |  Updated | June 23  |
...
| [解决加密密钥问题]({{ page.baseurl }}/cloud/trouble/trouble-crypt-key-variable.html){:target="_blank"} | 2.0, 2.1, 2.2 |  New | June 29  |
...
| [模板的XSS安全](http://devdocs.magento.com/guides/v2.2/frontend-dev-guide/templates/template-security.html){:target="_blank"} | 2.2 |  New | June 23  |
...
| Description  | Versions applied to  | New or Updated | Date |
|--------------|--------------|----------------------|--------|
| [di.xml文件](http://devdocs.magento.com/guides/v2.2/extension-dev-guide/build/di-xml-file.html){:target="_blank"} | 2.2 |  New | June 23  |
| [批量操作](http://devdocs.magento.com/guides/v2.2/extension-dev-guide/bulk-operations.html){:target="_blank"} | 2.2 |  New | June 23  |
| [批量操作实现示例](http://devdocs.magento.com/guides/v2.2/extension-dev-guide/implement-bulk.html){:target="_blank"} | 2.2 |  New | June 23  |
| [代码生成](http://devdocs.magento.com/guides/v2.2/extension-dev-guide/code-generation.html){:target="_blank"} | 2.2 |  New | June 23  |
| [配置导入器](http://devdocs.magento.com/guides/v2.2/extension-dev-guide/configuration/importers.html){:target="_blank"} | 2.2 |  New | June 23  |
| [敏感数据和环境变量](http://devdocs.magento.com/guides/v2.2/extension-dev-guide/configuration/sensitive-and-environment-settings.html){:target="_blank"} | 2.2 |  New | June 23  |
| [序列化库](http://devdocs.magento.com/guides/v2.2/extension-dev-guide/framework/serializer.html){:target="_blank"} | 2.2 |  New | June 23  |
| [索引优化](http://devdocs.magento.com/guides/v2.2/extension-dev-guide/indexer-batch.html){:target="_blank"} | 2.2 |  New | June 23  |
| [插件(拦截器)](http://devdocs.magento.com/guides/v2.2/extension-dev-guide/plugins.html){:target="_blank"} | 2.2 |  New | June 23  |
| [使用模型仓库搜索](http://devdocs.magento.com/guides/v2.2/extension-dev-guide/searching-with-repositories.html){:target="_blank"} | 2.2 |  New | June 23  |
| [XSS防范策略](http://devdocs.magento.com/guides/v2.2/extension-dev-guide/xss-protection.html){:target="_blank"} | 2.2 |  New | June 23  |
