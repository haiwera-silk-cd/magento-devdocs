...
If your style changes do not apply after refreshing the page, cleaning the static files cache might help. See the [清除静态文件缓存 topic]({{ page.baseurl }}/howdoi/clean_static_cache.html) for instructions how to do this.
