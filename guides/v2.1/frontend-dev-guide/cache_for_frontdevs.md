...
|----------------------------|----------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Layout                     | `layout`             | Compiled page layouts (that is, the layout 组件 from all 组件). Clean or flush this cache type after modifying layout files.                                                                                                                                                                                                          |
...
For more details about working with cache, see [管理缓存]({{ page.baseurl }}/config-guide/cli/config-cli-subcommands-cache.html)
