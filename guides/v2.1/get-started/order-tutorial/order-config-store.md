...
Upon clicking **Save**, a notification message states that the {% glossarytooltip 0bc9c8bc-de1a-4a06-9c99-a89a29c30645 %}缓存{% endglossarytooltip %} needs to be refreshed. Click the **System -> Tools ->Cache Management** link to refresh the cache.
