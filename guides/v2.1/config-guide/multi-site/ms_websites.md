...
4.	Enter `http://french.magento.mg` as the following example shows.
	...
	<div class="bs-callout bs-callout-info" id="info">
  		<p>If you're setting up a base URL for deployment {{site.data.var.ece}}, you must replace the first period with three dashes. 例如， if your base URL is <code>french.branch-sbg7pPa-f3dueAiM03tpy.us.magentosite.cloud</code>, enter <strong>http://french---branch-sbg7pPa-f3dueAiM03tpy.us.magentosite.cloud</strong>.</p>
...
4.	Enter `http://mysite.mg` as the following example shows.
	...
	<div class="bs-callout bs-callout-info" id="info">
  		<p>If you're setting up a base URL for {{site.data.var.ece}}, you must replace the first period with three dashes. 例如， if your base URL is <code>french.branch-sbg7pPa-f3dueAiM03tpy.us.magentosite.cloud</code>, enter <strong>http://french---branch-sbg7pPa-f3dueAiM03tpy.us.magentosite.cloud</strong>.</p>
	</div>
5.	Click **Save Config**.
