...
To use Elasticsearch on a [staging]({{ page.baseurl }}/cloud/reference/discover-arch.html#cloud-arch-stage) or [production]({{ page.baseurl }}/cloud/reference/discover-arch.html#cloud-arch-prod) system, open a [支持工单]({{ page.baseurl }}/cloud/welcome/get-help.html) and request Elasticsearch.
