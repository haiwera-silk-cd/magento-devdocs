...
![Overview of Starter configuration management]({{ site.magentourl }}/common/images/cloud_configmgmt-starter-2-1.png)
...
1.	Delete `config.local.php` in your Integration environment.
	...
	You must delete the file to change settings. All of your configurations still exist in the database, displaying as editable in your Magento Admin. Remember, the stored configurations in the file are blocked from editing in the Admin console until you delete the file. 例如， if you want to change a store name, you can't edit it until this file is removed.
