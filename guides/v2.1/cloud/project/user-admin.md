...
2.  Click the **Projects** tab as the following figure shows.
	...
	![Click the projects tab to access your Cloud project]({{ site.magentourl }}/common/images/cloud_account_project.png){:width="550px"}
...
4.	Click the configure project button next to project name in the top navigation bar as the following figure shows.
	...
	![Configure the project]({{ site.magentourl }}/common/images/cloud_project_gear.png){:width="184px"}
5.	In the right pane, click **Add Users**.

	![Start creating users]({{ site.magentourl }}/common/images/cloud_project-config.png){:width="500px"}
6.	Click **Add User**.

	![Add users]({{ site.magentourl }}/common/images/cloud_project-add-superuser.png){:width="500px"}
