...
<table>
<tr>
<th><p>Parameter</p></th><th><p>描述</p></th>
</tr>
<tr>
<td>name</td>
...
<p>例如: <code>customer.created</code>, <code>customer.sent.email</code></p>
...
*	<a href="{{ page.baseurl }}/config-guide/mq/manage-mysql.html">管理消息队列</a>
