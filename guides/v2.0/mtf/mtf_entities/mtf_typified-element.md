...
A typified element is an element of the GUI (Select, Multiselect etc). Magento has custom typified elements with a special logic, for example: Customized Select, Suggest Dropdown, {% glossarytooltip ca5a9ff1-8182-4fc4-a34b-9b3f831dbf3f %}Store View{% endglossarytooltip %} Selector. 典型元素s are often used as elements of a form or a grid.
...
  <p>The most important methods are <code>setValue()</code>和<code>getValue()</code>. These methods are required when you work with a form.</p>
</div>
