...
|`--collection`|`Magento\\Search\\Model\\ResourceModel\\Query\\Collection`|Collection to generate data sets. Synonyms are the entities of a Magento_Search模块. A collection can always be found in model resources.
...
![A new Synonym fixture]({{ site.magentourl }}/common/images/ftf/mtf_tut_fixt.png)
