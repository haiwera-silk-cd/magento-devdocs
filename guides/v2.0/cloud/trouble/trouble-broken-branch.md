...
例如， when using the Magento Cloud CLI commands, you may have received the error during a build: `E: Error building project: The build hook failed with status code 255. Build aborted`.
...
4. Push code to start a normal build and deploy process. For the full process, see [在本地构建和部署]({{ page.baseurl }}/cloud/live/live-sanity-check.html).
