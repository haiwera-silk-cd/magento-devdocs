...
title: Magento企业版(云支持版) 2.1.4 and 2.0.12 Release Notes
menu_title: Magento企业版(云支持版) 2.1.4 and 2.0.12 Release Notes
menu_order: 383
menu_node:
...
*	When you disable a {% glossarytooltip c1e4242b-1f1a-44c3-9d72-1d5b1435e142 %}模块{% endglossarytooltip %} and deploy it to the remote Cloud server, the module stays disabled.
