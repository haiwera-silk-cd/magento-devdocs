...
2. List all project variables with the command `magento-cloud project:variable:get`或`magento-cloud pvget`.
3. List all project variables with the command `magento-cloud variable:get`或`magento-cloud vget`.
