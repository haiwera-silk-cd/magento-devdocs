...
We recommend using their 安装向导 to walk you through the process:
...
3. Select the Builds tab. In the Builds side panel, click the info icon next to Magento Cloud. This opens a list of commands you will need to execute in order to enable the Blackfire integration.
	...
	![Click info icon]({{ site.magentourl }}/common/images/cloud_blackfire-builds.png)
	...
	![Blackfire Magento Cloud integragtion]({{ site.magentourl }}/common/images/cloud_blackfire-integration.png)
