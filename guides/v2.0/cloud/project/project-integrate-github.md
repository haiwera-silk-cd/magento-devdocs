...
5.	Select check boxes corresponding to how you intend to use the token:
	...
	*	To integrate with your organization's private repositories, select **repo** and **read:org**
	...
	![Create a GitHub token for a private repository]({{ site.magentourl }}/common/images/cloud_github-token.png){:width="600px"}
...
1.	In your GitHub repository, click **Settings** as the following figure shows.
	...
	![Go to your GitHub's account settings]({{ site.magentourl }}/common/images/cloud_github-acct-settings.png){:width="650px"}
2.	In the left navigation bar, click **Webhooks & services**.
3.	In the right pane, click **Add webhook** as the following figure shows.

	![Add the webhook to your account]({{ site.magentourl }}/common/images/cloud_github-acct-webhook.png){:width="650px"}
4.	Enter the following information:
	...
	*	Select the **Active** check box.
	...
	![Add the webhook to your account]({{ site.magentourl }}/common/images/cloud_github-acct-webhook2.png){:width="650px"}
5.	Click **Add webhook**
