...
{% highlight php %}
{% include magento/magento2/2.0/app/code/Magento/Sales/Api/InvoiceOrderInterface.php %}
{% endhighlight %}
...
{% highlight php %}
{% include magento/magento2/2.0/app/code/Magento/Sales/Model/InvoiceOrder.php %}
{% endhighlight %}
...
{% highlight php %}
{% include magento/magento2/2.0/app/code/Magento/Sales/Api/RefundInvoiceInterface.php %}
{% endhighlight %}
...
{% highlight php %}
{% include magento/magento2/2.0/app/code/Magento/Sales/Model/RefundInvoice.php %}
{% endhighlight %}
...
{% highlight php %}
{% include magento/magento2/2.0/app/code/Magento/Sales/Api/RefundOrderInterface.php %}
{% endhighlight %}
...
{% highlight php %}
{% include magento/magento2/2.0/app/code/Magento/Sales/Model/RefundOrder.php %}
{% endhighlight %}
...
{% highlight php %}
{% include magento/magento2/2.0/app/code/Magento/Sales/Api/ShipOrderInterface.php %}
{% endhighlight %}
...
{% highlight php %}
{% include magento/magento2/2.0/app/code/Magento/Sales/Model/ShipOrder.php %}
{% endhighlight %}
