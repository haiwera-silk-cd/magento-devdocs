...
1. For modularity purposes, GraphQL configuration must be declared in a separate module. 例如， to expose GraphQL for the module `MyModule`, you must create the `graphql.xml` file in the `MyModuleGraphQl` module.
