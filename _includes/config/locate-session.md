...
*	If you configured memcached, sessions are stored in RAM; for more information, see [使用memcached做为session存储]({{ page.baseurl }}/config-guide/memcache/memcache.html).
