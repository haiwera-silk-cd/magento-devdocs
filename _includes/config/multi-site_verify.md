...
### 故障排除
*	If your French and German sites return 404s but your Admin loads, make sure you completed [步骤6. Add the store code to the base URL]({{ page.baseurl }}/config-guide/multi-site/ms_websites.html#multi-storecode-baseurl).
