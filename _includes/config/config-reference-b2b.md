...
| Send Company Registration Email Copy To | `company/email/company_registration_copy` | | | ![Sensitive]({{ site.magentourl }}/common/images/cloud_sens.png)
...
| Send Company Status Change Email Copy To | `company/email/company_status_change_copy` | | | ![Sensitive]({{ site.magentourl }}/common/images/cloud_sens.png)
...
| Company Credit Change Email Sender | `company/email/company_credit_change` |  | | ![Sensitive]({{ site.magentourl }}/common/images/cloud_sens.png)
...
| Send Quote Email Copy To | `sales_email/quote/copy_to` | | | ![Sensitive]({{ site.magentourl }}/common/images/cloud_sens.png)
