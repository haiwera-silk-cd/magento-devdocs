...
![A page displays to confirm your backup was a success]({{ site.magentourl }}/common/images/extensman_backup-success.png){:width="650px"}

If errors display, see [解答备份问题]({{ page.baseurl }}/comp-mgr/trouble/cman/tshoot_backup.html)