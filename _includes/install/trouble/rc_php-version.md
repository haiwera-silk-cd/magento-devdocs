...
*	The PHP readiness check doesn't display the PHP version as the following figure shows.
	...
	This is a symptom of incorrect cron job setup. For more information, see [设置定时任务]({{ page.baseurl }}/install-gde/install/post-install-config.html#post-install-cron).
