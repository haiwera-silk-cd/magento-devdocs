...
The Magento software and component repository, `repo.magento.com`, recently started requiring Transport Layer Security (TLS) 1.1或更新.
...
![SSL connect error]({{ site.magentourl }}/common/images/install_ssl-connect-error.png)
